...
type ControllerGeneralMagentoDiff struct {
	attr.Arguments
	Old  string `arg:"-o,--old,required" help:"OLD Magento version (e.g., 2.4.8-p1) or path"`
	New  string `arg:"-n,--new,required" help:"NEW Magento version (e.g., 2.4.8-p2) or path"`
