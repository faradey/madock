...
func Execute() {
	...
	describeByLevel("install", "Install Magento or Shopware. It is a synonym for `madock magento setup:install` with additional actions.", 0)
	...
	describeByLevel("sy", "The short alias of `shopware` command", 0)
