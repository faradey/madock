...
func Execute() {
	...
	describeByLevel("--service-name", "DB container name. Optional. Default container: db. Example: db2", 1)
	describeByLevel("--ignore-table", "Ignore the table when exporting. The specified table will not be included in the backup file. To specify multiple tables, specify this option multiple times.", 1)
	...
	describeByLevel("--global", "Enable the service globally", 1)
	describeByLevel("service:disable", "Disable the service", 0)
	describeByLevel("[service name]", "Service name", 1)
	describeByLevel("--global", "Disable the service globally", 1)
