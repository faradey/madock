...
func Execute() {
	...
	describeByLevel("cloud", "Executing commands to work with PlatformVersion Cloud. Also, can be used the long command: magento-cloud", 0)
	...
	describeByLevel("install", "Install PlatformVersion. It is a synonym for `madock magento setup:install` with additional actions.", 0)
	...
	describeByLevel("magento", "Execute PlatformVersion command inside php container", 0)
	...
	describeByLevel("--path", "Path to file on server (from PlatformVersion root)", 1)
	describeByLevel("--ssh-type, -s", "SSH type (dev, stage, prod)", 1)
	...
	describeByLevel("--download, -d", "Download the specific PlatformVersion version from Composer to the container", 1)
	describeByLevel("--install, -i", "Install PlatformVersion from the source code", 1)
	describeByLevel("--sample-data, -s", "Install PlatformVersion Sample Data", 1)
	describeByLevel("--platform", "Platform (magento2, shopify, pwa, custom, etc.)", 1)
	describeByLevel("--platform-edition", "Platform edition (community or enterprise for PlatformVersion 2)", 1)
